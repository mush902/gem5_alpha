...
path = '/gem5/RLE-NOC_based_on_gem5/'
extnet = Extract_Network() # TL added 072520
...
def print_manaual_values():
        print('In print_manual_values()')
        pattern = "average_packet_latency"
        file = open('/gem5/gem5/m5out/stats.txt','r')
        for line in file:
...
def icn_routing_gym(ith_eps, injrate, action, topology):     
	...
	os_command = "./build/ALPHA/gem5.opt configs/example/garnet_synth_traffic.py \
