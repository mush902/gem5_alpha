...
iter_step = 18 # injection from 0.05 to 0.6, step 0.05;
...
csvfile = 'QL_xy_'+str(iter_step)+'_'+str(total_episodes)+ '.csv'
...
np.savetxt("Reward_history_qlearning_xy.csv", rew_history, delimiter=",")
...
plt.xlabel('Episodes')
plt.ylabel('Reward')
plt.savefig('QL_xy_'+str(iter_step)+'_'+str(total_episodes)+'_RLNOC.png', bbox_inches='tight')
